...
<html>
  <head>    
    <? echo '<TITLE>Editando el Sala Preembarque '.$almacen_id.'</TITLE>';?>
  ...
  <form id="idFormulario" name='formulario'>
    ...
    <h1 id="titulo">DATOS DEL ALMACEN <? echo "$almacen_id"; ?> </h1>
      ...
      <div id="contenedor1Preembarque">  
       <?
        echo "NOMBRE&nbsp;<input id='razon' name='nombre' type='text'  value='$nombre' size='50' maxlength='50' required/><br>";      
        echo "HABILITACION DE SENASA&nbsp<img src='fotos/senasa.JPG' width='20' height='20'><input name='hab_senasa' type='text' id='senasa' value="."'".$hab_senasa."'"."  size='20' maxlength='20'>";
      ...
      <div id="contenedor5"> 
        ...
        <!--button id="btnmapa" name="mapa" value"mapa">MAPA</button-->        
      </div><!--fin contenedor5 -->  
  ...
  ?>
  <!-- es para el efecto del mapa -->
  <!--div id="mapa"> 
  </div-->   
    
  </body>
  <script src="../frames/js/botoneraSalaPreembarque.js" type="text/javascript"> </script>     
</html>