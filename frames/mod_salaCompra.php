...
<html>
	<head>   	
   	<? echo '<TITLE>Editando Compra '.$almacen_id.'</TITLE>';?>
  ...
  <form id="idFormulario" name='formulario'>
    ...
    <h1 id="titulo">DATOS DE COMPRADOR <? echo "$almacen_id"; ?> </h1>
    
    <div id="contenedor1Compra">  
      <?
        echo "COMPRADOR&nbsp;<input id='razon' name='nombre' type='text'  value='$nombre' size='50' maxlength='50' required/><br>";	     
  ...
  <script src="../frames/js/botoneraSalaCompra.js" type="text/javascript"> </script>     
</html>