...
<html>
    ...
    <div id="contenedor1Acopio">  
      <?
        echo "SALA DE ACOPIO<input id='razon' name='nombre' type='text'  value='$nombre' size='50' maxlength='50' required/><br>";	     
		    echo "N&Uacute;MERO DE HABILITACION DE SENASA:&nbsp<img src='fotos/senasa.JPG' width='20' height='20'><input name='hab_senasa' type='text' id='senasa' value="."'".$hab_senasa."'"."  size='20' maxlength='20'>";
      ...
      <h4> <img id="abrir_contenedorHORA" src="fotos/desplegar0.png"/> HORARIOS DE ATENCI&Oacute;N </h4>
  ...
  <script src="../frames/js/botoneraSalaAcopio.js" type="text/javascript"> </script>     
</html>