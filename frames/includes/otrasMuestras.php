...
for ( $a=0; $a < $cantidad; $a++){    
	// $SQL = " SELECT analitico_inf.nomencl, analisis.id_tambor, analisis.cod_analisis_id, analisis.resultado 
 //             FROM analisis INNER JOIN analitico_inf ON analisis.cod_analisis_id = analitico_inf.cod_anal_id
 //             WHERE id_tambor = ".$vector[$a]." AND cod_analisis_id BETWEEN 1 AND 25 GROUP BY cod_analisis_id ORDER BY cod_analisis_id ASC";   
