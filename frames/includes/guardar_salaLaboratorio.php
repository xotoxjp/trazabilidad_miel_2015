...
if($accion=="edit"){        
    $SQL = 'UPDATE almacenes 
            ...
            tel1="'.$tel1.'",cel1="'.$cel1.'", email1="'.$email1.'",hor1="'.$hora1.'", hor2="'.$hora2.'",hab_senasa="'.$senasa.'"
            WHERE almacen_id = "'.$almacen_id.'"';
}
else{
    $SQL = "INSERT INTO almacenes (almacen_id,razon_social,dir1, Localidad, cod_postal, provincia, pais, cond_iva, nro_cuit, contacto, tel, cel, fax, nextel, email, contacto1, tel1, cel1, email1,hor1,hor2,tipo_almacen, hab_senasa)  
            VALUES ('$almacen_id','$razon','$dir1','$localidad','$cod_postal','$provincia','$pais','$cond_iva', '$nro_cuit','$contacto','$tel','$cel','$fax','$nextel','$email', '$contacto1', '$tel1','$cel1','$email1','$hora1','$hora2','$tipo_almacen','$senasa')";
}
