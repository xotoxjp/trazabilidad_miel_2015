   ...
   $( "#seleccion" ).change(function () {
    ...
    $("#gridanalisisp").setGridParam({url:'grid/analisisPistolGrid.php?tipoMuestra='+eleccionTipoMuestra2});
	...
	jQuery("#gridanalisisp").jqGrid({
		url:'grid/analisisPistolGrid.php?tipoMuestra='+eleccionTipoMuestra2,
		datatype: "JSON",
	...
	jQuery("#analizar").click(function(){     
		...
		if(selectedRowId != 0){
			...
			location.href='alta_laboratorio1.php?tambores='+tamselect;			
		 }
		 else{
