$(document).ready( function(){       
            ...
            if(!verificarLogin(login)){
               ...
               // alert("otra vez salgo con un alert!!!!!");
		        ...
		        $.ajax({
			        ...
			        type: 'POST',
			        dataType: 'json',
			        url: '../controlador/guardar.php?modo='+modo,
			        processData: false, 
			        contentType: false,
        ...
        function verificarLogin(login){
            ...
            $.ajax({
		        dataType: 'json',
		        url: '../controlador/verificarLogin.php?login='+login,
		        processData: false, 
		        contentType: false,
		        async: false,
		        success: function(response){
        ...
        $("#configuracion").click( function(){           
           location.href = "../controlador/configuracion.php?id="+id+"&modo="+modo;           
        });
        
        /***********************************************/
        
        $("#volver").click( function(){
           location.href = href="../controlador/usuario.php";
        }); 
