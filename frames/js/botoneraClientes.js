    ...
    console.log(accion);    
    if (accion == 'edit'){
      var ruta = 'includes/guardar_modClientes.php?accion='+accion;      
    }
    else{
      ruta = 'includes/guardar_modClientes.php?accion='+accion;
    } 

    $("#btnvolver").click(function(){
      event.preventDefault();
      location.href="clientes1.php";
    });
    ...
    /*$("#btnimprimir").click(function(){
      event.preventDefault();
     //location.href ="imp1.php?&ar=$cliente_id"; 
    });*/    
