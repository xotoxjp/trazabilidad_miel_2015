    ...
    console.log(accion);    
    if (accion == 'edit'){
      var ruta = 'includes/guardar_salaExportador.php?accion='+accion;
      //console.log(ruta);
    }
    else{
      ruta = 'includes/guardar_salaExportador.php?accion='+accion;
    }  

    $("#btnvolver").click(function(){
      event.preventDefault();
      location.href="almacenes1.php";
    });
    ...
    $("#contenedor2Exportador").slideToggle("slow");
