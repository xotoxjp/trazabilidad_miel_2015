...
$( "#seleccion" ).change(function () {
    ...
    $("#listsg11").setGridParam({url:'../frames/subgrid/analisisGrid.php?tipoMuestra='+eleccionTipoMuestra});
...
jQuery("#listsg11").jqGrid({
   	url:'../frames/subgrid/analisisGrid.php?tipoMuestra='+eleccionTipoMuestra,
	datatype: "JSON",
	...
	subGridRowExpanded: function(subgrid_id, row_id) {
		...
		jQuery("#"+subgrid_table_id).jqGrid({
			url:"../frames/subgrid/analisisSubgrid.php?tipoMuestra="+eleccionTipoMuestra+"&id="+row_id,
			datatype: "JSON",
		...
		jQuery("#editar_analisis").click(function(){     
		 ...
		 var tamselect = idsOfSelectedRows.sort(function(a,b){
	 	 ...
	 	 location.href='alta_laboratorio3.php?quiero='+registrar+'&tambores='+ tamselect ;
		});	
	    ...
	    jQuery("#ver_analisis").click(function(){     
		 ...
		 selectedRowId = myGrid.jqGrid ('getGridParam', 'selarrrow');
	 	 ...
	 	 location.href='alta_laboratorio3.php?quiero='+ver+'&tambores='+ tamselect;
		});	
