...
if ($agrego_cliente== "si"){
  $act="SELECT max( cliente_id ) FROM ".$_SESSION["tabla_clientes"];
  ...
  $cliente_id = $num_cliente_proximo;
}
/********************************************************************************************************/
...
if( $edit =='edit'){ 
  ...
  mysql_select_db($_SESSION["base_acc"]);
  $consulta ="SELECT * FROM  ".$_SESSION["tabla_clientes"]. " WHERE cliente_id=".$cliente_id ;
  $respuesta = mysql_query($consulta,$conexion);

  while ($v_validar = mysql_fetch_array($respuesta)){
    $cliente_id= $v_validar[0]; 
    $nombre= $v_validar[1];
    $dir1= $v_validar[2];
    //$dir2= $v_validar[3];
...
<html>
	<head>   	
   	<? echo '<TITLE>Editando el Cliente '.$cliente_id.'</TITLE>';?>
  ...
  <form id="idFormulario" name='formulario'>
	    ...
	    <h1 id="titulo">DATOS DEL CLIENTE <? echo "$cliente_id"; ?> </h1>
        
        <div id="contenedor1Cliente">  
		    <?
          echo "NOMBRE CLIENTE&nbsp;<input id='razon' name='nombre' type='text'  value='$nombre' size='50' maxlength='50' required />";			    
      ...
      <div id="contenedor2">
         <?
          ...
          echo"<p>&nbsp;&nbsp;email&nbsp;<input name='email' type='email' id='email'  value='$email' size='30' maxlength='30' />";
      ...
      <div id="contenedor3">
        <?
          ...
          echo"&nbsp;&nbsp;email<input name='email1' type='email' id='email1' value="."'".$email1."'"."  size='12' maxlength='30' /></p>";
       ?> 
      </div><!--fin contenedor3-->
      <br>
  ...
  <?
    echo "<input id='cliente_id' type='hidden' name='' value='".$cliente_id."'>";  
    // solo funciona si se edita el cliente
    if($edit=="edit"){
     echo "<input id='accion' type='hidden' name='' value='edit'>";
    }
    // solo funciona si es nuevo el cliente
    if ($agrego_cliente =="si"){
  ...
  <script src="../frames/js/botoneraClientes.js" type="text/javascript"> </script>     
</html>