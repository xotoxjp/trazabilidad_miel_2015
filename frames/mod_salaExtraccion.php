...
<html>
    ...
    <div id="contenedor1Ext">  
       <?
        echo "SALA:<input id='razon' name='nombre' type='text'  value='$nombre' size='50' maxlength='50' required/><br>";	     
		    echo "NUMERO DE HABILITACI&Oacute;N DE SENASA:&nbsp<img src='fotos/senasa.JPG' width='20' height='20'><input name='hab_senasa' type='text' id='senasa' value="."'".$hab_senasa."'"."  size='20' maxlength='20' />";
       ?>
    </div><!-- fin contenedor1 -->
  ...
  <script src="../frames/js/botoneraSalaExt.js" type="text/javascript"> </script>     
</html>