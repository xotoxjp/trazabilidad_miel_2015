...
".$where." ORDER BY ".$sidx." ".$sord." LIMIT ".$start." , ".$limit." "; 
 ...
 while($row = mysql_fetch_array($result,MYSQL_ASSOC)) { 
    ...
    $responce->rows[$i]['cell']=array($row['id_tambor'],$row['renapa'],$row['sala_ext']
    ,$row['peso'],$row['tara'],$row['peso_neto'],$row['color'],$row['fecha_llegada'],$row['remito'],$row['almacen'],$row['tipo_miel'],$row['num_loteGSB'],$row['rango'],""); 
    $i++;
 } 
